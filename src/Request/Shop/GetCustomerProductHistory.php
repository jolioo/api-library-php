 ...
 */
class GetCustomerProductHistory extends RequestAbstract {
    ...
    protected function getPath() {
        return 'shop/getcustomerproducthistory';
    }
    ...
    /**
     * @return \JoliooAPI\Response\Shop\GetCustomerProductHistory|ResponseAbstract|null
     */
    public function execute() {
        if ($responseData = $this->executeIt($valid)) {
            if ($valid) {
                return new \JoliooAPI\Response\Shop\GetCustomerProductHistory($responseData);
            }
